...
class Parameters:
    ...
    def fifth_chat_parameters(self, prompt="Complete a frase: 'A inteligência artifical será...'"):
        "Modelo mais balanceado, top_p 0.7 - Equilibrado"
        ...
        response = reponse_balance.choices[0].message.content
